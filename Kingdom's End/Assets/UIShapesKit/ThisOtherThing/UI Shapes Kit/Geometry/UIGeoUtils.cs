...
namespace ThisOtherThing.UI
{
	public class GeoUtils
	{
		...
		public class RoundingProperties
		{
			...
			[ThisOtherThing.Utils.MinAttribute(2)]public int FixedResolution = 10;
			[ThisOtherThing.Utils.MinAttribute(0.01f)]public float ResolutionMaxDistance = 4.0f;
		...
		public class ShadowsProperties
		{
			...
			[ThisOtherThing.Utils.MinAttribute(0.0f)] public float Distance = 0.0f;
		...
		public class ShadowProperties
		{
			...
			[ThisOtherThing.Utils.MinAttribute(0.0f)] public float Size = 5.0f;
