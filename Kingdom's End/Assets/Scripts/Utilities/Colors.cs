...
public class Colors
{
  ...
  public static Dictionary<string, Color> effectWheelColors = new() {
    ...
    {"air-infusion", new Color(0.486f, 0.988f, 0.000f)},
    ...
    {"dark-infusion", new Color(0.251f, 0.251f, 0.251f)},
    ...
    {"light-infusion", new Color(0.753f, 0.753f, 0.753f)},
