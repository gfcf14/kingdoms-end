...
public class Objects
{
  ...
  public static Dictionary<string, RegularItem> regularItems = new() {
    {"air-med", new RegularItem(Sprites.itemThumbnails[247], Sprites.itemImages[247], "Air Medicine", "Provides resistance against air magic.", "consumable", 350, new Effects() {duration=30, magicResistances=new MagicResistance[]{new MagicResistance(){name="Air", type="add"}}})},
    ...
    // must rename
    {"calcite", new RegularItem(Sprites.itemThumbnails[277], Sprites.itemImages[277], "Calcite", "The magical core of a skeleton which did not explode upon its death.", "valuable", 1000)},
    ...
    {"dark-med", new RegularItem(Sprites.itemThumbnails[253], Sprites.itemImages[253], "Dark Medicine", "Provides resistance against dark magic.", "consumable", 350, new Effects() {duration=30, magicResistances=new MagicResistance[]{new MagicResistance(){name="Dark", type="add"}}})},
    ...
    {"darklord-sword", new RegularItem(Sprites.itemThumbnails[31], Sprites.itemImages[31], "Darklord Sword", "Sword reserved for high ranked lords of chaos.", "double", 500, new Effects() {atk=50})},
    ...
    {"earth-med", new RegularItem(Sprites.itemThumbnails[246], Sprites.itemImages[246], "Earth Medicine", "Provides resistance against earth magic.", "consumable", 350, new Effects() {duration=30, magicResistances=new MagicResistance[]{new MagicResistance(){name="Earth", type="add"}}})},
    ...
    {"fire-med", new RegularItem(Sprites.itemThumbnails[249], Sprites.itemImages[249], "Fire Medicine", "Provides resistance against fire magic.", "consumable", 350, new Effects() {duration=30, magicResistances=new MagicResistance[]{new MagicResistance(){name="Fire", type="add"}}})},
    ...
    {"ice-med", new RegularItem(Sprites.itemThumbnails[251], Sprites.itemImages[251], "Ice Medicine", "Provides resistance against ice magic.", "consumable", 350, new Effects() {duration=30, magicResistances=new MagicResistance[]{new MagicResistance(){name="Ice", type="add"}}})},
    ...
    {"knife", new RegularItem(Sprites.itemThumbnails[86], Sprites.itemImages[86], "Knife", "Could be used to spread butter on bread.", "throwable", 300, new Effects() {atk=15})},
    ...
    {"leprechaun-mushroom", new RegularItem(Sprites.itemThumbnails[202], Sprites.itemImages[202], "Forest Mushroom", "Rare mushroom found by leprechauns. Can heal poison but hurts if not poisoned.", "valuable", 1000)},
    {"light-med", new RegularItem(Sprites.itemThumbnails[252], Sprites.itemImages[252], "Light Medicine", "Provides resistance against light magic.", "consumable", 350, new Effects() {duration=30, magicResistances=new MagicResistance[]{new MagicResistance(){name="Light", type="add"}}})},
    {"lightning-med", new RegularItem(Sprites.itemThumbnails[250], Sprites.itemImages[250], "Lightning Medicine", "Provides resistance against lightning magic.", "consumable", 350, new Effects() {duration=30, magicResistances=new MagicResistance[]{new MagicResistance(){name="Lightning", type="add"}}})},
    ...
    {"pearl", new RegularItem(Sprites.itemThumbnails[274], Sprites.itemImages[274], "Pearl", "Natural treasure of the seas.", "valuable", 1000)},
    ...
    // must delete
    {"polished-king-skull", new RegularItem(Sprites.itemThumbnails[389], Sprites.itemImages[389], "Polished King Skull", "A more refined head from a skeleton king", "valuable", 1000)},
    // must delete
    {"polished-skull", new RegularItem(Sprites.itemThumbnails[287], Sprites.itemImages[287], "Polished Skull", "A sturdier skull from a higher ranked skeleton.", "valuable", 1000)},
    ...
    // must rename
    {"precious-calcite", new RegularItem(Sprites.itemThumbnails[278], Sprites.itemImages[278], "Precious", "Elite skeleton calcite which harnessed much of its reanimation magic.", "valuable", 1000)},
    ...
    {"silver-skull", new RegularItem(Sprites.itemThumbnails[288], Sprites.itemImages[288], "Silver Skull", "Skull from elite skeletons.", "valuable", 1000)},
    ...
    {"skull", new RegularItem(Sprites.itemThumbnails[287], Sprites.itemImages[287], "Skull", "A skeleton’s head, useful for museum display or to decorate an eccentric person’s house.", "valuable", 1000)},
    ...
    {"water-med", new RegularItem(Sprites.itemThumbnails[248], Sprites.itemImages[248], "Water Medicine", "Provides resistance against water magic.", "consumable", 350, new Effects() {duration=30, magicResistances=new MagicResistance[]{new MagicResistance(){name="Water", type="add"}}})},
    ...
    // must rename
    {"wine", new RegularItem(Sprites.itemThumbnails[216], Sprites.itemImages[216], "Wine", "Brewed to perfection for a long time.", "food", 100, new Effects() {hp=100, mp=-20})},
