...
public class Objects
{
  ...
  public static Dictionary<string, RegularItem> regularItems = new() {
    ...
    {"leprechaun-mushroom", new RegularItem(Sprites.itemThumbnails[106], Sprites.itemImages[106], "Forest Mushroom", "Rare mushroom found by leprechauns. Can heal poison but hurts if not poisoned.", "valuable")},
