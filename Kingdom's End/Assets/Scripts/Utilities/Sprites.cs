...
public class Sprites {
  ...
  public static Dictionary<string, Sprite> droppableSprites = new() {
    ...
    {"pearl", droppableImages[274]},
    {"pineapple", droppableImages[206]},
    // must delete
    {"polished-king-skull", droppableImages[389]},
    // must delete
    {"polished-skull", droppableImages[287]},
    ...
    // must delete
    {"refined-calcite", droppableImages[277]},
    ...
    {"silver-skull", droppableImages[288]},
    {"skeleton-king-giant-bone", droppableImages[106]},
    {"skull", droppableImages[287]},
