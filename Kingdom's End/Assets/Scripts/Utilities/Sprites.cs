...
public class Sprites {
  ...
  public static Dictionary<string, Sprite> keyToEffectSprites = new() {
    ...
    {"dark-1", effectWheelSprites[32]},
    {"dark-2", effectWheelSprites[32]},
    {"dark-3", effectWheelSprites[32]},
    {"earth-1", effectWheelSprites[25]},
    {"earth-2", effectWheelSprites[25]},
    {"earth-3", effectWheelSprites[25]},
    {"fire-1", effectWheelSprites[28]},
    {"fire-2", effectWheelSprites[28]},
    {"fire-3", effectWheelSprites[28]},
    {"ice-1", effectWheelSprites[30]},
    {"ice-2", effectWheelSprites[30]},
    {"ice-3", effectWheelSprites[30]},
    {"light-1", effectWheelSprites[31]},
    {"light-2", effectWheelSprites[31]},
    {"light-3", effectWheelSprites[31]},
    {"lightning-1", effectWheelSprites[31]},
    {"lightning-2", effectWheelSprites[29]},
    {"lightning-3", effectWheelSprites[29]},
