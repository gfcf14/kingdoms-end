...
public class Constants {
  ...
  public static string[] consumableEffects = {"air-infusion", "dark-infusion", "earth-infusion", "fire-infusion", "ice-infusion", "light-infusion", "lightning-infusion", "speed-potion", "water-infusion"};

  public static string[] variableEnemies = { "luxhusk", "nomad", "wanderess" };
  public static string[] fragmentableThrowables = { "watermelon" };
  public static string[] fragmentableProjectiles = { "centaur-spear", "dyrgja-hatchet", "janissary-yatagan", "kitsune-kunai", "knight-dagger", "leprechaun-mushroom", "nomad-dagger", "pegasus-feather", "scarabhorn", "siren-feather", "skeleton-king-giant-bone", "skullguard-dagger", "sylphid-feather", "yukionna-kunai" };
