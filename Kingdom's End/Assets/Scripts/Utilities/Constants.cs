...
public class Constants {
  ...
  public static string[] nonBouncingProjectiles = {"dwarf-cobble", "fairy-blast", "frostbird-orb", "goblin-knife", "mummy-rib", "nereid-seashell", "neret-orb", "nymph-acorn", "phoenix-orb", "pixie-fireball", "samodiva-stalagtip", "skeleton-bone", "skelewing-orb", "thunderbird-orb", "troll-boulder", "unicorn-shard"};
  ...
  public static string[] flyingEnemies = {"fairy", "frostbird", "neret", "phoenix", "pixie", "skelewing", "thunderbird"};
  ...
  public static string[] enemyProjectiles = {"centaur-spear", "dwarf-cobble", "fairy-blast", "frostbird-orb", "goblin-knife", "mummy-rib", "nereid-seashell", "neret-orb", "nymph-acorn", "phoenix-orb", "pixie-fireball", "samodiva-stalagtip", "skeleton-bone", "skelewing-orb", "thunderbird-orb", "troll-boulder", "unicorn-shard"};
