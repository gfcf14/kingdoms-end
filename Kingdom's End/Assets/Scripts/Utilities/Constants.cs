...
public class Constants {
  ...
  public static string[] nonBouncingProjectiles = {"dwarf-cobble", "fairy-blast", "frostbird-orb", "goblin-knife", "nereid-seashell", "neret-orb", "nymph-acorn", "phoenix-orb", "pixie-fireball", "skeleton-bone", "thunderbird-orb", "troll-boulder", "unicorn-shard"};
  ...
  public static string[] rotatingProjectiles = {"fairy-blast", "frostbird-orb", "neret-orb", "phoenix-orb", "pixie-fireball", "skeleton-bone", "thunderbird-orb", "troll-boulder"};
  ...
  public static string[] flyingEnemies = {"fairy", "frostbird", "neret", "phoenix", "pixie", "thunderbird"};
  ...
  public static string[] enemyProjectiles = {"centaur-spear", "dwarf-cobble", "fairy-blast", "frostbird-orb", "goblin-knife", "nereid-seashell", "neret-orb", "nymph-acorn", "phoenix-orb", "pixie-fireball", "skeleton-bone", "thunderbird-orb", "troll-boulder", "unicorn-shard"};
  public static string[] explodingThrowables = {"fairy-blast", "frostbird-orb", "neret-orb", "phoenix-orb", "pixie-fireball", "thunderbird-orb"};
