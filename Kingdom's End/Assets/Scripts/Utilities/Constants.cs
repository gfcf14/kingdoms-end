...
public class Constants {
  ...
  public static string[] nonBouncingProjectiles = {"dwarf-cobble", "cyclops-hillstone", "fairy-blast", "frostbird-orb", "goblin-knife", "hippocampus-scale", "kelpie-fin", "mermaid-scale", "merman-scale", "mummy-rib", "nereid-seashell", "neret-orb", "nymph-acorn", "ogre-stump", "phoenix-orb", "pixie-fireball", "samodiva-stalagtip", "skeleton-bone", "skelewing-orb", "thunderbird-orb", "troll-boulder", "unicorn-shard", "yanmabel-stinger"};
  ...
  public static string[] enemyProjectiles = {"centaur-spear", "cyclops-hillstone", "dwarf-cobble", "fairy-blast", "frostbird-orb", "goblin-knife", "hippocampus-scale", "kelpie-fin", "mermaid-scale", "merman-scale", "mummy-rib", "nereid-seashell", "neret-orb", "nymph-acorn", "ogre-stump", "phoenix-orb", "pixie-fireball", "samodiva-stalagtip", "skeleton-bone", "skelewing-orb", "thunderbird-orb", "troll-boulder", "unicorn-shard", "yanmabel-stinger"};
