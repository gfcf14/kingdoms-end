...
public class Constants {
  ...
  public static string[] nonBouncingProjectiles = {"dwarf-cobble", "fairy-blast", "frostbird-orb", "goblin-knife", "hippocampus-scale", "kelpie-fin", "mermaid-scale", "merman-scale", "mummy-rib", "nereid-seashell", "neret-orb", "nymph-acorn", "phoenix-orb", "pixie-fireball", "samodiva-stalagtip", "skeleton-bone", "skelewing-orb", "thunderbird-orb", "troll-boulder", "unicorn-shard", "yanmabel-stinger"};
  ...
  public static string[] rotatingProjectiles = {"fairy-blast", "frostbird-orb", "mummy-rib", "neret-orb", "phoenix-orb", "pixie-fireball", "skeleton-bone", "skelewing-orb", "thunderbird-orb", "troll-boulder"};
  ...
  public static string[] enemyProjectiles = {"centaur-spear", "dwarf-cobble", "fairy-blast", "frostbird-orb", "goblin-knife", "hippocampus-scale", "kelpie-fin", "mermaid-scale", "merman-scale", "mummy-rib", "nereid-seashell", "neret-orb", "nymph-acorn", "phoenix-orb", "pixie-fireball", "samodiva-stalagtip", "skeleton-bone", "skelewing-orb", "thunderbird-orb", "troll-boulder", "unicorn-shard", "yanmabel-stinger"};
