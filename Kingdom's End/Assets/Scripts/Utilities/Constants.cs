...
public class Constants {
  ...
  public static string[] nonBouncingProjectiles = {"dwarf-cobble", "goblin-knife", "nymph-acorn", "skeleton-bone"};
  ...
  public static string[] enemyProjectiles = {"dwarf-cobble", "goblin-knife", "nymph-acorn", "skeleton-bone"};
