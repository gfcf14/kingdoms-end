...
public class Constants {
  ...
  public static string[] nonBouncingProjectiles = {"dwarf-cobble", "fairy-blast", "frostbird-orb", "goblin-knife", "hippocampus-scale", "mermaid-scale", "mummy-rib", "nereid-seashell", "neret-orb", "nymph-acorn", "phoenix-orb", "pixie-fireball", "samodiva-stalagtip", "skeleton-bone", "skelewing-orb", "thunderbird-orb", "troll-boulder", "unicorn-shard", "yanmabel-stinger"};
  ...
  public static string[] enemyProjectiles = {"centaur-spear", "dwarf-cobble", "fairy-blast", "frostbird-orb", "goblin-knife", "hippocampus-scale", "mermaid-scale", "mummy-rib", "nereid-seashell", "neret-orb", "nymph-acorn", "phoenix-orb", "pixie-fireball", "samodiva-stalagtip", "skeleton-bone", "skelewing-orb", "thunderbird-orb", "troll-boulder", "unicorn-shard", "yanmabel-stinger"};
